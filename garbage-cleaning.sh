...
#removendo lixo e pacotes temporários de programas instalados que foram atualizados
...
#limpando os kernels que não são mais utilizados e que continuam no seu hard disk
...
#faz com que todo o cache do sistema de aquivos que está temporariamente armazenado na memória cache,
